...
CORE_AGENTS = ["intake_agent", "diagnosis_agent", "treatment_agent", "verification_agent", "orchestrator"]
...
def generate_examples(agent_name):
    ...
    categories = ["Simple", "Complex", "Ambiguous", "Missing Information", "Conflicting Reports", "Emergency", "Invalid Request"]
...
print("Generated core agent prompts and 20 examples each.")
